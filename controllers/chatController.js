...
export const acessChats = expressAsyncHandler(async (req, res) => {
...
export const fechChats = expressAsyncHandler(async (req, res) => {
  try {
...
export const createGroupChat = expressAsyncHandler(async (req, res) => {
  if (!req.body.users || !req.body.name) {
    return res.status(400).json({ message: "please fille all the fields" });
  }
